                    ...
                    renderList.map((item, index) => (
                        <li key={index} className="list-item">
                            <div className="columns">
                                <div className="column is-two-third" style={item.completed ? { textDecoration: 'line-through' } : {}}>{item.text}</div>
                                <div className="column">
                                    <div className="buttons are-small is-pulled-right">
                                        {!item.completed && <button onClick={() => this.props.doneTodo(index)} className="button is-primary is-outlined">
                                            Done
    </button>}
                                        <button onClick={() => this.props.deleteTodo(index)} className="button is-danger is-outlined">
                                            Delete
    </button>
                                    </div>
                                </div>
